...
$url0 = "https://api.auragold.in/api/profile/v1/user-banks";
$headers0 = array(
...
curl_setopt_array($curl0, [
  ...
  CURLOPT_TIMEOUT => 30,
  CURLOPT_HTTPHEADER => $headers0,
   // For response headers (true)
  CURLOPT_HEADER => false,
]);
$output0 = curl_exec($curl0);

curl_close($curl0);

$url = "https://api.auragold.in/api/profile/v1/verify-bank";

$data = '{"bank_account":"'.$acc.'","ifsc":"'.$ifsc.'"}';
...
echo "<div class='blue' role='alert'>$output</div>";
